...
CREATE TABLE IF NOT EXISTS users (
    ...
    role        VARCHAR(20)     NOT NULL COMMENT '인증서버 호환용. STUDENT | INSTRUCTOR 외의 값 저장 금지',
    user_role   VARCHAR(20)     COMMENT '도메인 역할. BUYER(제약사·연구실) | SUPPLIER(공급 공장)',
    company_name    VARCHAR(200) COMMENT '기관명 또는 공장명',
    business_number VARCHAR(50)  COMMENT '사업자등록번호',
    gmp_certified   BOOLEAN      COMMENT 'GMP 인증 보유 여부. SUPPLIER에만 해당',
